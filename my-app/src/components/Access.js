...
const ForbiddenAnimation = () => {
  useEffect(() => {
    ...
    const interval = setInterval(keyAnimate, 3000);
  ...
  return (
    ...
    >
      <div id="container_anim" style={{ position: "relative", width: "100%", height: "70%",overflow:"hidden" }}>
        ...
        <div id="key" style={{ position: "absolute", top: "60%", left: "-5%" }}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            xmlnsXlink="http://www.w3.org/1999/xlink"
            style={{ isolation: "isolate" }}
